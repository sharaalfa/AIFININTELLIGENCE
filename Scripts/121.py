...
kv_ = np.concatenate([kv06, kv07, kv08, kv09, kv10, kv11, kv.values, kv3.values, kv4.values, kv5.values]) #соединаем в одну колонку кварталы по годам, только значения
data_05_32 = c05[:32]
...
kv4 = data_142.unstack().head()
kv5 = data_152.unstack().head()
kv_1 = np.concatenate([kv06, kv07, kv08, kv09, kv10, kv11, kv.values, kv3.values, kv4.values, kv5.values]) #соединаем в одну колонку кварталы по годам, только значения
...
kv4 = data_142.unstack().head()
kv5 = data_152.unstack().head()
kv_2 = np.concatenate([kv06, kv07, kv08, kv09, kv10, kv11, kv.values, kv3.values, kv4.values, kv5.values]) #соединаем в одну колонку кварталы по годам, только значения
...
kv4 = data_142.unstack().head()
kv5 = data_152.unstack().head()
kv_3 = np.concatenate([kv06, kv07, kv08, kv09, kv10, kv11, kv.values, kv3.values, kv4.values, kv5.values])
data_05_44 = c05[:44]
...
kv4 = data_142.unstack().head()
kv5 = data_152.unstack().head()
kv_4 = np.concatenate([kv06, kv07, kv08, kv09, kv10, kv11, kv.values, kv3.values, kv4.values, kv5.values])
data_05_45 = c05[:45]
...
kv4 = data_142.unstack().head()
kv5 = data_152.unstack().head()
kv_5 = np.concatenate([kv06, kv07, kv08, kv09, kv10, kv11, kv.values, kv3.values, kv4.values, kv5.values])
data_05_46 = c05[:46]
...
kv4 = data_142.unstack().head()
kv5 = data_152.unstack().head()
kv_6 = np.concatenate([kv06, kv07, kv08, kv09, kv10, kv11, kv.values, kv3.values, kv4.values, kv5.values])
data_05_47 = c05[:47]
...
kv4 = data_142.unstack().head()
kv5 = data_152.unstack().head()
kv_7 = np.concatenate([kv06, kv07, kv08, kv09, kv10, kv11, kv.values, kv3.values, kv4.values, kv5.values])
data_05_48 = c05[:48]
...
kv4 = data_142.unstack().head()
kv5 = data_152.unstack().head()
kv_8 = np.concatenate([kv06, kv07, kv08, kv09, kv10, kv11, kv.values, kv3.values, kv4.values, kv5.values])
data_05_49 = c05[:49]
...
kv4 = data_142.unstack().head()
kv5 = data_152.unstack().head()
kv_9 = np.concatenate([kv06, kv07, kv08, kv09, kv10, kv11, kv.values, kv3.values, kv4.values, kv5.values])
data_05_50 = c05[:50]
...
kv4 = data_142.unstack().head()
kv5 = data_152.unstack().head()
kv_10 = np.concatenate([kv06, kv07, kv08, kv09, kv10, kv11, kv.values, kv3.values, kv4.values, kv5.values])
data_05_51 = c05[:51]
...
kv4 = data_142.unstack().head()
kv5 = data_152.unstack().head()
kv_11 = np.concatenate([kv06, kv07, kv08, kv09, kv10, kv11, kv.values, kv3.values, kv4.values, kv5.values])
data_05_52 = c05[:52]
...
kv4 = data_142.unstack().head()
kv5 = data_152.unstack().head()
kv_12 = np.concatenate([kv06, kv07, kv08, kv09, kv10, kv11, kv.values, kv3.values, kv4.values, kv5.values])
data_05_53 = c05[:53]
...
kv4 = data_142.unstack().head()
kv5 = data_152.unstack().head()
kv_13 = np.concatenate([kv06, kv07, kv08, kv09, kv10, kv11, kv.values, kv3.values, kv4.values, kv5.values])
data_05_53 = c05[:55]
data_052 = (data_05_53[-1:])
data_06_53 = c06[:55]
data_062 = (data_06_53[-1:])
...
kv4 = data_142.unstack().head()
kv5 = data_152.unstack().head()
kv_14 = np.concatenate([kv06, kv07, kv08, kv09, kv10, kv11, kv.values, kv3.values, kv4.values, kv5.values])
data_05_53 = c05[:56]
data_052 = (data_05_53[-1:])
data_06_53 = c06[:56]
data_062 = (data_06_53[-1:])
...
kv4 = data_142.unstack().head()
kv5 = data_152.unstack().head()
kv_15 = np.concatenate([kv06, kv07, kv08, kv09, kv10, kv11, kv.values, kv3.values, kv4.values, kv5.values])
data_05_53 = c05[:57]
data_052 = (data_05_53[-1:])
data_06_53 = c06[:57]
data_062 = (data_06_53[-1:])
...
kv4 = data_142.unstack().head()
kv5 = data_152.unstack().head()
kv_16 = np.concatenate([kv06, kv07, kv08, kv09, kv10, kv11, kv.values, kv3.values, kv4.values, kv5.values])
data_05_63 = c05[:63]
...
kv4 = data_142.unstack().head()
kv5 = data_152.unstack().head()
kv_23 = np.concatenate([kv06, kv07, kv08, kv09, kv10, kv11, kv.values, kv3.values, kv4.values, kv5.values])
data_05_63 = c05[:62]
data_052 = (data_05_63[-1:])
data_06_63 = c06[:62]
data_062 = (data_06_63[-1:])
...
kv4 = data_142.unstack().head()
kv5 = data_152.unstack().head()
kv_24 = np.concatenate([kv06, kv07, kv08, kv09, kv10, kv11, kv.values, kv3.values, kv4.values, kv5.values])
c5 = data_R5[:3]
c6 = data_R6[:3]
c7 = data_R7[:3]
c8 = data_R8[:3]
...
df = np.concatenate([k6,k7,k8,k9,k10,k11,k12,k13,k14,k15])
...
rep_val=repo['VALUE'].resample('Q', how='mean')/10000000
micx = micex['CLOSE'].resample('Q', how='mean')
micx_val=micex['VALUE'].resample('Q', how='mean')/1000000
...
kv2 = pd.DataFrame({'Cальдо сч.т.о.и сч.о.к.':kv_,
                    ...
                    'Ошибки и пропуски без ссуд и депозитов и резервов':
                        abs(kv_7-kv_16)+abs(kv_6-kv_15)+kv_11+abs(kv_23)+abs(kv_24),
                    'РЕПО сред.':rep.values,
                    'ММВБ сред.':micx.values,
                    'РЕПО min.':rep_min.values,
                    'ММВБ min.':micx_min.values,
                    'РЕПО max.':rep_max.values,
                    'ММВБ max.':micx_max.values,
                    'РЕПО сред.об.':rep_val.values,
                    'ММВБ сред.об.':micx_val.values,
                    'РЕПО min val':rep_val_min.values,
                    'ММВБ min val':micx_val_min.values,
                    'РЕПО max val':rep_val_max.values,
                    'ММВБ max val':micx_val_max.values,})
#kv2.to_excel('D:/work/data/BOP_RUS2.xlsx')
#z = kv2['Сомнит. операции']
#figure()
#plot(z.values, 'r', label='Net errors/omissions(abs)')
#plot(rep_val.values, 'y', label='REPO')
#plot(micx_val.values, 'g', label='MICEX')
#legend()
#title('INDEXs')
#show()
