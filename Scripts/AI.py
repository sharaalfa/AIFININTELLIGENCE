...
def fetchPreMarket(link,a,b):
    ...
    d=pd.DataFrame({'g':v})
    d.to_excel('D:/work/data1/m.xlsx')

    return d

while True:
    a = pd.read_excel('D:\work\data1\Data_mlv_rost_multireg_perebor.xlsx')
    b=pd.read_excel('D:\work\data1\Data_mlv_rost_multireg_perebor.xlsx')
    b.columns=\
    ...
    a1=pd.read_excel('D:/work/data1/m.xlsx')
    ...
    print(testModels)
    testModels.to_excel('D:/work/data1/predict.xlsx')
    time.sleep(60)
