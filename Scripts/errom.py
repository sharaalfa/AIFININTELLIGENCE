...
#прочие инвестиции(РФ), выдеяем строку
...
kaz = data_kaz[:231]#another invest kaz
kz_inv = kaz[-1:]
#в столбец
...
kaz_in = kz_inv.unstack().head(32)
#соединаем в одну колонку кварталы по годам, только значения, и соотвествующие данные по другим странам
kv_2 = np.concatenate(
    [kv06, kv07, kv08, kv09, kv10, kv11,
     kv.values, kv3.values, kv4.values, kv5.values, kaz_in])
...
kv_11 = np.concatenate([kv06-kv071.values,
                        kv07-kv071.values,
                        kv08-kv081.values,
                        kv09-kv091.values,
                        kv10-kv101.values,
...
rep_val=repo['VALUE'].resample('Q', how='mean')/100000
...
ind_un_min=np.concatenate([micx_min,kaz_min.loc[52],
                            kaz_min.loc[104],
                            kaz_min.loc[156],
                            kaz_min.loc[208],
                            kaz_min.loc[260],
                           ...
                           kaz_min.loc[1612],
                           kaz_min.loc[1664]])
ind_un_mean=np.concatenate([micx,kaz_mean.loc[52],
                            kaz_mean.loc[104],
                            kaz_mean.loc[156],
                            kaz_mean.loc[208],
                            kaz_mean.loc[260],
                           ...
                           kaz_mean.loc[1612],
                           kaz_mean.loc[1664]])
ind_un_max=np.concatenate([micx_max,kaz_max.loc[52],
                            kaz_max.loc[104],
                            kaz_max.loc[156],
                            kaz_max.loc[208],
                            kaz_max.loc[260],
...
repo_un_min=np.concatenate([rep_min,kaz_min.loc[52],
                            kaz_min.loc[104],
                            kaz_min.loc[156],
                            kaz_min.loc[208],
                            kaz_min.loc[260],
                           ...
                           kaz_min.loc[1612],
                           kaz_min.loc[1664]])
repo_un_mean=np.concatenate([rep,kaz_mean.loc[52],
                            kaz_mean.loc[104],
                            kaz_mean.loc[156],
                            kaz_mean.loc[208],
                            kaz_mean.loc[260],
                           ...
                           kaz_mean.loc[1612],
                           kaz_mean.loc[1664]])
repo_un_max=np.concatenate([rep_max,kaz_max.loc[52],
                            kaz_max.loc[104],
                            kaz_max.loc[156],
                            kaz_max.loc[208],
                            kaz_max.loc[260],
...
repval_un_min=np.concatenate([rep_val_min,kaz_min.loc[52],
                            kaz_min.loc[104],
                            kaz_min.loc[156],
                            kaz_min.loc[208],
                            kaz_min.loc[260],
                           ...
                           kaz_min.loc[1612],
                           kaz_min.loc[1664]])
repval_un_mean=np.concatenate([rep_val,kaz_mean.loc[52],
                            kaz_mean.loc[104],
                            kaz_mean.loc[156],
                            kaz_mean.loc[208],
                            kaz_mean.loc[260],
                           ...
                           kaz_mean.loc[1612],
                           kaz_mean.loc[1664]])
repval_un_max=np.concatenate([rep_val_max,kaz_max.loc[52],
                            kaz_max.loc[104],
                            kaz_max.loc[156],
                            kaz_max.loc[208],
                            kaz_max.loc[260],
...
indval_un_min=np.concatenate([micx_val_min,kaz_min.loc[52],
                            kaz_min.loc[104],
                            kaz_min.loc[156],
                            kaz_min.loc[208],
                            kaz_min.loc[260],
                           ...
                           kaz_min.loc[1612],
                           kaz_min.loc[1664]])
indval_un_mean=np.concatenate([micx_val,kaz_mean.loc[52],
                            kaz_mean.loc[104],
                            kaz_mean.loc[156],
                            kaz_mean.loc[208],
                            kaz_mean.loc[260],
                           ...
                           kaz_mean.loc[1612],
                           kaz_mean.loc[1664]])
indval_un_max=np.concatenate([micx_val_max,kaz_max.loc[52],
                            kaz_max.loc[104],
                            kaz_max.loc[156],
                            kaz_max.loc[208],
                            kaz_max.loc[260],
...
kv2 = pd.DataFrame({'Прочие инвестиции': kv_2,
...
#kv2.to_excel('D:/work/data/ruskaz1.xlsx')
figure()
