...
micx_median=0.014777*(micex['CLOSE'].resample('Q', how='median')/9.36)
micx_max = 0.014777*(micex['CLOSE'].resample('Q', how='max')/9.36)
#China, Shanchai, 2005-2015
c_min=0.125*(pd.rolling_min(dfdf(u'D:\work\data\shan.xlsx',"A1:A2636"), 60)/1.7)
c_mean=0.125*(pd.rolling_mean(dfdf(u'D:\work\data\shan.xlsx',"A1:A2636"), 60)/1.7)
c_median=0.125*(pd.rolling_median(dfdf(u'D:\work\data\shan.xlsx',"A1:A2636"), 60)/1.7)
c_max=0.125*(pd.rolling_max(dfdf(u'D:\work\data\shan.xlsx',"A1:A2636"), 60)/1.7)
# GBr 2005-2015
br_min=1.41*(pd.rolling_min(dfdf(u'D:\work\data\gbr.xlsx',"A1:A3071"), 68)/5.92)
br_mean=1.41*(pd.rolling_mean(dfdf(u'D:\work\data\gbr.xlsx',"A1:A3071"), 68)/5.92)
br_median=1.41*(pd.rolling_median(dfdf(u'D:\work\data\gbr.xlsx',"A1:A3071"), 68)/5.92)
br_max=1.41*(pd.rolling_max(dfdf(u'D:\work\data\gbr.xlsx',"A1:A3071"), 68)/5.92)
#Brazil, 2005-2015
b_min=0.28*(pd.rolling_min(dfdf(u'D:\work\data\zin.xlsx', "A1:A2862"), 64)/7.4)
b_mean=0.28*(pd.rolling_mean(dfdf(u'D:\work\data\zin.xlsx', "A1:A2862"), 64)/7.4)
b_median=0.28*(pd.rolling_median(dfdf(u'D:\work\data\zin.xlsx', "A1:A2862"), 64)/7.4)
b_max=0.28*(pd.rolling_max(dfdf(u'D:\work\data\zin.xlsx', "A1:A2862"), 64)/7.4)
# USA, 2005-2015
...
# France, 2005-2014
f_min = 1.14*(pd.rolling_min(dfdf(u'D:\work\data\kkr.xlsx',"A1:A2345"), 62)/6.12)
f_mean =  1.14*(pd.rolling_mean(dfdf(u'D:\work\data\kkr.xlsx',"A1:A2345"), 62)/6.12)
f_median = 1.14*(pd.rolling_median(dfdf(u'D:\work\data\kkr.xlsx',"A1:A2345"), 62)/6.12)
f_max =  1.14*(pd.rolling_max(dfdf(u'D:\work\data\kkr.xlsx',"A1:A2345"), 62)/6.12)
#Kazachstan, 2007(IV)-2015(III)
kaz_min =  0.00365*(pd.rolling_min(dfdf(u'D:\work\data\kaz_index.xlsx',"A1:A1971"), 50)/11.5)
kaz_mean = 0.00365*(pd.rolling_mean(dfdf(u'D:\work\data\kaz_index.xlsx',"A1:A1971"), 50)/11.5)
kaz_median=0.00365*(pd.rolling_median(dfdf(u'D:\work\data\kaz_index.xlsx',"A1:A1971"), 50)/11.5)
kaz_max = 0.00365*(pd.rolling_max(dfdf(u'D:\work\data\kaz_index.xlsx',"A1:A1971"), 50)/11.5)
...
kv2 = pd.DataFrame({'Чистые ошибки и пропуски(С)':kv_11,
                    ...
                    'Индекс медиана':acbmk(usa_median,c_median,br_median,f_median,b_median,micx_median,kaz_median)
                    })

kv2.to_excel('D:/work/data/Model_7country.xlsx')
#pp=kv2.corr('Чистые ошибки и пропуски(С)',
            #'Чистые ошибки и пропуски',
            #'Ошибки и пропуски',
            #'Абс. чоп','Индекс сред.',
            #'Индекс мин','Индекс макс',
            #'Индекс медиана')
#pp.to_excel('D:/work/data/Model_corr_table2.xlsx')