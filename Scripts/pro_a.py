...
kv2 = pd.DataFrame({'Чистые ошибки и пропуски(С)':kv_11,
                    ...
                    'Абс. чоп':abs(kv_23),
                    'Индекс сред.':acbmk(usa_mean,c_mean,br_mean,f_mean,micx,kaz_mean),
                    'Индекс мин':acbmk(usa_min,c_min,br_min,f_min,micx_min,kaz_min),
                    'Индекс макс':acbmk(usa_max,c_max,br_max,f_max,micx_max,kaz_max),
                    'Индекс медиана':acbmk(usa_max,c_median,br_median,f_median,micx_median,kaz_median)
                    })

kv2.to_excel('D:/work/data/Model_br.xlsx')
