...
c_min=pd.rolling_min(shanchai, 60)
c_mean=pd.rolling_mean(shanchai, 60)
c_max=pd.rolling_max(shanchai, 60)
...
#kv2.to_excel('D:/work/data/Model_z1.xlsx')
#figure()
