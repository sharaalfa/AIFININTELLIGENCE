...
dojo = Excel21.Workbooks.Open(u'D:\work\data\dj1.xlsx')
...
dojov = Excel22.Workbooks.Open(u'D:\work\data\dj1.xlsx')
...
kaz_min =  0.01*pd.rolling_min(kaz_ind, 50)

kaz_mean = 0.01*pd.rolling_mean(kaz_ind, 50)
kaz_max = 0.01*pd.rolling_max(kaz_ind, 50)
...
repo_oblmbs_un_min=np.concatenate([usa_min.loc[62],
                            usa_min.loc[124],
                            usa_min.loc[186],
                            usa_min.loc[248],
                            usa_min.loc[310],
                           ...
                           kaz_min.loc[1612],
                           kaz_min.loc[1664]])
repo_oblmbs_un_mean=np.concatenate([usa_mean.loc[62],
                            usa_mean.loc[124],
                            usa_mean.loc[186],
                            usa_mean.loc[248],
                            usa_mean.loc[310],
                           ...
                           kaz_mean.loc[1612],
                           kaz_mean.loc[1664]])
repo_oblmbs_un_max=np.concatenate([usa_max.loc[62],
                            usa_max.loc[124],
                            usa_max.loc[186],
                            usa_max.loc[248],
                            usa_max.loc[310],
...
kaz_mean =  pd.rolling_mean(kaz_repo, 50)
kaz_max = pd.rolling_max(kaz_repo, 50)
repo_obltreu_un_min=np.concatenate([usa_min.loc[62],
                            usa_min.loc[124],
                            usa_min.loc[186],
                            usa_min.loc[248],
                            usa_min.loc[310],
                           ...
                           kaz_min.loc[1612],
                           kaz_min.loc[1664]])
repo_obltreu_un_mean=np.concatenate([usa_mean.loc[62],
                            usa_mean.loc[124],
                            usa_mean.loc[186],
                            usa_mean.loc[248],
                            usa_mean.loc[310],
                           ...
                           kaz_mean.loc[1612],
                           kaz_mean.loc[1664]])
repo_obltreu_un_max=np.concatenate([usa_max.loc[62],
                            usa_max.loc[124],
                            usa_max.loc[186],
                            usa_max.loc[248],
                            usa_max.loc[310],
...
kaz_mean =  pd.rolling_mean(kaz_repo, 50)
kaz_max = pd.rolling_max(kaz_repo, 50)
repo_oblagen_un_min=np.concatenate([usa_min.loc[62],
                            usa_min.loc[124],
                            usa_min.loc[186],
                            usa_min.loc[248],
                            usa_min.loc[310],
                           ...
                           kaz_min.loc[1612],
                           kaz_min.loc[1664]])
repo_oblagen_un_mean=np.concatenate([usa_mean.loc[62],
                            usa_mean.loc[124],
                            usa_mean.loc[186],
                            usa_mean.loc[248],
                            usa_mean.loc[310],
                           ...
                           kaz_mean.loc[1612],
                           kaz_mean.loc[1664]])
repo_oblagen_un_max=np.concatenate([usa_max.loc[62],
                            usa_max.loc[124],
                            usa_max.loc[186],
                            usa_max.loc[248],
                            usa_max.loc[310],
...
kaz_mean =  pd.rolling_mean(kaz_repo, 50)
kaz_max = pd.rolling_max(kaz_repo, 50)
repo_acmbs_un_min=np.concatenate([usa_min.loc[62],
                            usa_min.loc[124],
                            usa_min.loc[186],
                            usa_min.loc[248],
                            usa_min.loc[310],
                           ...
                           kaz_min.loc[1612],
                           kaz_min.loc[1664]])
repo_acmbs_un_mean=np.concatenate([usa_mean.loc[62],
                            usa_mean.loc[124],
                            usa_mean.loc[186],
                            usa_mean.loc[248],
                            usa_mean.loc[310],
                           ...
                           kaz_mean.loc[1612],
                           kaz_mean.loc[1664]])
repo_acmbs_un_max=np.concatenate([usa_max.loc[62],
                            usa_max.loc[124],
                            usa_max.loc[186],
                            usa_max.loc[248],
                            usa_max.loc[310],
...
kaz_mean =  pd.rolling_mean(kaz_repo, 50)
kaz_max = pd.rolling_max(kaz_repo, 50)
repo_actreu_un_min=np.concatenate([usa_min.loc[62],
                            usa_min.loc[124],
                            usa_min.loc[186],
                            usa_min.loc[248],
                            usa_min.loc[310],
                           ...
                           kaz_min.loc[1612],
                           kaz_min.loc[1664]])
repo_actreu_un_mean=np.concatenate([usa_mean.loc[62],
                            usa_mean.loc[124],
                            usa_mean.loc[186],
                            usa_mean.loc[248],
                            usa_mean.loc[310],
                           ...
                           kaz_mean.loc[1612],
                           kaz_mean.loc[1664]])
repo_actreu_un_max=np.concatenate([usa_max.loc[62],
                            usa_max.loc[124],
                            usa_max.loc[186],
                            usa_max.loc[248],
                            usa_max.loc[310],
...
kaz_mean =  pd.rolling_mean(kaz_repo, 50)
kaz_max = pd.rolling_max(kaz_repo, 50)
repo_acagen_un_min=np.concatenate([usa_min.loc[62],
                            usa_min.loc[124],
                            usa_min.loc[186],
                            usa_min.loc[248],
                            usa_min.loc[310],
                           ...
                           kaz_min.loc[1612],
                           kaz_min.loc[1664]])
repo_acagen_un_mean=np.concatenate([usa_mean.loc[62],
                            usa_mean.loc[124],
                            usa_mean.loc[186],
                            usa_mean.loc[248],
                            usa_mean.loc[310],
                           ...
                           kaz_mean.loc[1612],
                           kaz_mean.loc[1664]])
repo_acagen_un_max=np.concatenate([usa_max.loc[62],
                            usa_max.loc[124],
                            usa_max.loc[186],
                            usa_max.loc[248],
                            usa_max.loc[310],
...
indval_un_min=np.concatenate([usa_min.loc[64],
                            usa_min.loc[128],
                            usa_min.loc[192],
                            usa_min.loc[256],
                            usa_min.loc[320],
                           ...
                           kaz_min.loc[1612],
                           kaz_min.loc[1664]])
indval_un_mean=np.concatenate([usa_mean.loc[64],
                            usa_mean.loc[128],
                            usa_mean.loc[192],
                            usa_mean.loc[256],
                            usa_mean.loc[320],
                           ...
                           kaz_mean.loc[1612],
                           kaz_mean.loc[1664]])
indval_un_max=np.concatenate([usa_max.loc[64],
                            usa_max.loc[128],
                            usa_max.loc[192],
                            usa_max.loc[256],
                            usa_max.loc[320],
...
#kv2.to_excel('D:/work/data/usrukz55.xlsx')
figure()
...
def polyfit(x, y, degree):
   ...
   # r-squared
    ...
    return results
a = abs(kv_23)
b = ind_un_max*repo_acagen_un_max*repo_oblagen_un_max
print(polyfit(b, a, 2))