...
kazah.Close()
Excel5.Quit()
Excel6 = win32com.client.Dispatch("Excel.Application")
kazahin = Excel6.Workbooks.Open(u'D:\work\data\kaz_index.xlsx')
...
kazahval.Close()
Excel4.Quit()
Excel8 = win32com.client.Dispatch("Excel.Application")
usaval = Excel8.Workbooks.Open(u'D:\work\data\olusa.xlsx')
sheet = usaval.ActiveSheet
vals8 = [r[0].value for r in sheet.Range("E1:E2853")]
usa_vol = pd.DataFrame(vals8)
usaval.Close()
Excel8.Quit()
Excel9 = win32com.client.Dispatch("Excel.Application")
usapr = Excel9.Workbooks.Open(u'D:\work\data\ssusa.xls')
sheet = usapr.ActiveSheet
vals9 = [r[0].value for r in sheet.Range("F16:F2880")]
...
rep = z.resample('Q', how='median')
rep_val=repo['VALUE'].resample('Q', how='median')
micx = micex['CLOSE'].resample('Q', how='median')
micx_val=micex['VALUE'].resample('Q', how='median')
...
usa_mean =  pd.rolling_median(dojo_val, 62)
usa_max = pd.rolling_max(dojo_val, 62)
kaz_min =  pd.rolling_min(kaz_ind, 50)

kaz_mean =  pd.rolling_median(kaz_ind, 50)
...
ind_un_max=np.concatenate([usa_max.loc[64],
                           ...
                           kaz_max.loc[1612],
                           kaz_max.loc[1664]])
usa_min =  pd.rolling_min(usa_pr, 62)

usa_mean =  pd.rolling_median(usa_pr, 62)
usa_max = pd.rolling_max(usa_pr, 62)
kaz_min =  pd.rolling_min(kaz_repo, 50)

kaz_mean =  pd.rolling_median(kaz_repo, 50)
kaz_max = pd.rolling_max(kaz_repo, 50)
repo_un_min=np.concatenate([usa_min.loc[64],
                            usa_min.loc[128],
                            usa_min.loc[192],
                            usa_min.loc[256],
                            usa_min.loc[320],
                           ...
                           kaz_min.loc[1612],
                           kaz_min.loc[1664]])
repo_un_mean=np.concatenate([usa_mean.loc[64],
                            usa_mean.loc[128],
                            usa_mean.loc[192],
                            usa_mean.loc[256],
                            usa_mean.loc[320],
                           ...
                           kaz_mean.loc[1612],
                           kaz_mean.loc[1664]])
repo_un_max=np.concatenate([usa_max.loc[64],
                            usa_max.loc[128],
                            usa_max.loc[192],
                            usa_max.loc[256],
                            usa_max.loc[320],
                           ...
                           kaz_max.loc[1612],
                           kaz_max.loc[1664]])
usa_min =  pd.rolling_min(usa_vol, 55)

usa_mean =  pd.rolling_median(usa_vol, 55)
usa_max = pd.rolling_max(usa_vol, 55)
kaz_min =  pd.rolling_min(kaz_value, 50)

kaz_mean =  pd.rolling_median(kaz_value, 50)
kaz_max = pd.rolling_max(kaz_value, 50)
repval_un_min=np.concatenate([usa_min.loc[64],
                            usa_min.loc[128],
                            usa_min.loc[192],
                            usa_min.loc[256],
                            usa_min.loc[320],
                           ...
                           kaz_min.loc[1612],
                           kaz_min.loc[1664]])
repval_un_mean=np.concatenate([usa_mean.loc[64],
                            usa_mean.loc[128],
                            usa_mean.loc[192],
                            usa_mean.loc[256],
                            usa_mean.loc[320],
                           ...
                           kaz_mean.loc[1612],
                           kaz_mean.loc[1664]])
repval_un_max=np.concatenate([usa_max.loc[64],
                            usa_max.loc[128],
                            usa_max.loc[192],
                            usa_max.loc[256],
                            usa_max.loc[320],
...
usa_mean =  pd.rolling_median(dojo_vol, 62)
usa_max = pd.rolling_max(dojo_vol, 62)
kaz_min =  pd.rolling_min(kaz_indval, 50)
kaz_mean =  pd.rolling_median(kaz_indval, 50)
...
#kv2.to_excel('D:/work/data/ruskaz2.xlsx')
figure()
...
print(polyfit(x, y, 2))
#t= kv2.corr()
#t.to_excel('D:/work/data/fgg.xlsx')