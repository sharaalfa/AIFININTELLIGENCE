...
data_usa = pd.read_excel('D:/work/data/USA.xlsx', skeep_footer=6, index_col=0, parse_col="A,V:AS")
...
thusa_fa = usa_fa.unstack().head(24)
kv_3 = np.concatenate(
    [thusa_fa, kv06, kv07, kv08, kv09, kv10, kv11, kv.values,
...
thusa_cda=usa_cda.unstack().head(24)
...
thusa_kza=usa_kza.unstack().head(24)
kv_7 = np.concatenate(
    [thusa_kza, kv06, kv07, kv08, kv09, kv10,
...
thusa_tka=usa_tka.unstack().head(24)
kv_9 = np.concatenate(
    [thusa_tka, kv06, kv07, kv08,
...
thusa_neo= usa_neo.unstack().head(24)
kv_11 = np.concatenate([thusa_neo,
                        kv06-kv071.values,
                        kv07-kv071.values,
                        kv08-kv081.values,
                        kv09-kv091.values,
...
thusa_fp=usa_fp.unstack().head(24)
...
thusa_cdp=usa_cdp.unstack().head(24)
...
thusa_kzp=usa_kzp.unstack().head(24)
...
thusa_res=usa_res.unstack().head(24)
...
thusa_tkp=usa_tkp.unstack().head(24)
...
kazah.Close()
Excel5.Quit()
Excel62 = win32com.client.Dispatch("Excel.Application")
kazahin = Excel62.Workbooks.Open(u'D:\work\data\kaz_index.xlsx')
...
usapr.Close()
Excel11.Quit()
Excel12 = win32com.client.Dispatch("Excel.Application")
usapr = Excel12.Workbooks.Open(u'D:\work\data\guol.xlsx')
sheet = usapr.ActiveSheet
vals9 = [r[0].value for r in sheet.Range("A1:A72")]
usa_pr_vol = pd.DataFrame(vals9)
usapr.Close()
Excel12.Quit()
Excel13 = win32com.client.Dispatch("Excel.Application")
usapr = Excel13.Workbooks.Open(u'D:\work\data\guol.xlsx')
sheet = usapr.ActiveSheet
vals9 = [r[0].value for r in sheet.Range("B1:B72")]
usa_pr_treu_vol = pd.DataFrame(vals9)
usapr.Close()
Excel13.Quit()
Excel14 = win32com.client.Dispatch("Excel.Application")
usapr = Excel14.Workbooks.Open(u'D:\work\data\guol.xlsx')
sheet = usapr.ActiveSheet
vals9 = [r[0].value for r in sheet.Range("C1:C72")]
usa_pr_agen_vol = pd.DataFrame(vals9)
usapr.Close()
Excel14.Quit()
...
rep_ac_val=repo_ac['VALUE'].resample('Q', how='mean')
...
ind_un_min=np.concatenate([usa_min.loc[1346],
                            usa_min.loc[1410],
                            usa_min.loc[1474],
                            usa_min.loc[1538],
                            usa_min.loc[1602],
                           ...
                           kaz_min.loc[1612],
                           kaz_min.loc[1664]])
ind_un_mean=np.concatenate([usa_mean.loc[1346],
                            usa_mean.loc[1410],
                            usa_mean.loc[1474],
                            usa_mean.loc[1538],
                            usa_mean.loc[1602],
                           ...
                           kaz_mean.loc[1612],
                           kaz_mean.loc[1664]])
ind_un_max=np.concatenate([usa_max.loc[1346],
                            usa_max.loc[1410],
                            usa_max.loc[1474],
                            usa_max.loc[1538],
                            usa_max.loc[1602],
                           ...
                           kaz_max.loc[1612],
                           kaz_max.loc[1664]])
#данные по репо % от казахстана с госбумагами,
#от РФ по облигациям из ломбардного списка ЦБ,
#от США c Fannie Mae and Freddie Mac
usa_min =  pd.rolling_min(usa_pr, 60)

usa_mean =  pd.rolling_mean(usa_pr, 60)
usa_max = pd.rolling_max(usa_pr, 60)
kaz_min =  pd.rolling_min(kaz_repo, 50)

kaz_mean =  pd.rolling_mean(kaz_repo, 50)
kaz_max = pd.rolling_max(kaz_repo, 50)
repo_oblmbs_un_min=np.concatenate([ usa_min.loc[1302],
                            usa_min.loc[1364],
                            usa_min.loc[1426],
                            usa_min.loc[1488],
                            usa_min.loc[1550],
                           ...
                           kaz_min.loc[1612],
                           kaz_min.loc[1664]])
repo_oblmbs_un_mean=np.concatenate([usa_mean.loc[1302],
                            usa_mean.loc[1364],
                            usa_mean.loc[1426],
                            usa_mean.loc[1488],
                            usa_mean.loc[1550],
                           ...
                           kaz_mean.loc[1612],
                           kaz_mean.loc[1664]])
repo_oblmbs_un_max=np.concatenate([usa_max.loc[1302],
                            usa_max.loc[1364],
                            usa_max.loc[1426],
                            usa_max.loc[1488],
                            usa_max.loc[1550],
                           ...
                           kaz_max.loc[1612],
                           kaz_max.loc[1664]])
#по РФ и Казахстану те же, по США-treasury
usa_min =  pd.rolling_min(usa_pr_treu, 60)

usa_mean =  pd.rolling_mean(usa_pr_treu, 60)
usa_max = pd.rolling_max(usa_pr_treu, 60)
kaz_min =  pd.rolling_min(kaz_repo, 50)

kaz_mean =  pd.rolling_mean(kaz_repo, 50)
kaz_max = pd.rolling_max(kaz_repo, 50)
repo_obltreu_un_min=np.concatenate([usa_min.loc[1302],
                            usa_min.loc[1364],
                            usa_min.loc[1426],
                            usa_min.loc[1488],
                            usa_min.loc[1550],
                           ...
                           kaz_min.loc[1612],
                           kaz_min.loc[1664]])
repo_obltreu_un_mean=np.concatenate([usa_mean.loc[1302],
                            usa_mean.loc[1364],
                            usa_mean.loc[1426],
                            usa_mean.loc[1488],
                            usa_mean.loc[1550],
                           ...
                           kaz_mean.loc[1612],
                           kaz_mean.loc[1664]])
repo_obltreu_un_max=np.concatenate([usa_max.loc[1302],
                            usa_max.loc[1364],
                            usa_max.loc[1426],
                            usa_max.loc[1488],
                            usa_max.loc[1550],
                           ...
                           kaz_max.loc[1612],
                           kaz_max.loc[1664]])
#по РФ и Каз те же, США-с ипотечным покрытием от агентства
usa_min =  pd.rolling_min(usa_pr_agen, 60)

usa_mean =  pd.rolling_mean(usa_pr_agen, 60)
usa_max = pd.rolling_max(usa_pr_agen, 60)
kaz_min =  pd.rolling_min(kaz_repo, 50)

kaz_mean =  pd.rolling_mean(kaz_repo, 50)
kaz_max = pd.rolling_max(kaz_repo, 50)
repo_oblagen_un_min=np.concatenate([usa_min.loc[1302],
                            usa_min.loc[1364],
                            usa_min.loc[1426],
                            usa_min.loc[1488],
                            usa_min.loc[1550],
                           ...
                           kaz_min.loc[1612],
                           kaz_min.loc[1664]])
repo_oblagen_un_mean=np.concatenate([usa_mean.loc[1302],
                            usa_mean.loc[1364],
                            usa_mean.loc[1426],
                            usa_mean.loc[1488],
                            usa_mean.loc[1550],
                           ...
                           kaz_mean.loc[1612],
                           kaz_mean.loc[1664]])
repo_oblagen_un_max=np.concatenate([usa_max.loc[1302],
                            usa_max.loc[1364],
                            usa_max.loc[1426],
                            usa_max.loc[1488],
                            usa_max.loc[1550],
                           ...
                           kaz_max.loc[1664]])
#данные по репо % от казахстана с госбумагами,
#от РФ по акциям из ломбардного списка ЦБ,
#от США c Fannie Mae and Freddie Mac
usa_min =  pd.rolling_min(usa_pr, 60)
...
kaz_mean =  pd.rolling_mean(kaz_repo, 50)
kaz_max = pd.rolling_max(kaz_repo, 50)
repo_acmbs_un_min=np.concatenate([usa_min.loc[1302],
                            usa_min.loc[1364],
                            usa_min.loc[1426],
                            usa_min.loc[1488],
                            usa_min.loc[1550],
                           ...
                           kaz_min.loc[1612],
                           kaz_min.loc[1664]])
repo_acmbs_un_mean=np.concatenate([usa_mean.loc[1302],
                            usa_mean.loc[1364],
                            usa_mean.loc[1426],
                            usa_mean.loc[1488],
                            usa_mean.loc[1550],
                           ...
                           kaz_mean.loc[1612],
                           kaz_mean.loc[1664]])
repo_acmbs_un_max=np.concatenate([usa_max.loc[1302],
                            usa_max.loc[1364],
                            usa_max.loc[1426],
                            usa_max.loc[1488],
                            usa_max.loc[1550],
...
kaz_mean =  pd.rolling_mean(kaz_repo, 50)
kaz_max = pd.rolling_max(kaz_repo, 50)
repo_actreu_un_min=np.concatenate([usa_min.loc[1302],
                            usa_min.loc[1364],
                            usa_min.loc[1426],
                            usa_min.loc[1488],
                            usa_min.loc[1550],
                           ...
                           kaz_min.loc[1612],
                           kaz_min.loc[1664]])
repo_actreu_un_mean=np.concatenate([usa_mean.loc[1302],
                            usa_mean.loc[1364],
                            usa_mean.loc[1426],
                            usa_mean.loc[1488],
                            usa_mean.loc[1550],
                           ...
                           kaz_mean.loc[1612],
                           kaz_mean.loc[1664]])
repo_actreu_un_max=np.concatenate([usa_max.loc[1302],
                            usa_max.loc[1364],
                            usa_max.loc[1426],
                            usa_max.loc[1488],
                            usa_max.loc[1550],
...
kaz_mean =  pd.rolling_mean(kaz_repo, 50)
kaz_max = pd.rolling_max(kaz_repo, 50)
repo_acagen_un_min=np.concatenate([usa_min.loc[1302],
                            usa_min.loc[1364],
                            usa_min.loc[1426],
                            usa_min.loc[1488],
                            usa_min.loc[1550],
                           ...
                           kaz_min.loc[1612],
                           kaz_min.loc[1664]])
repo_acagen_un_mean=np.concatenate([usa_mean.loc[1302],
                            usa_mean.loc[1364],
                            usa_mean.loc[1426],
                            usa_mean.loc[1488],
                            usa_mean.loc[1550],
                           ...
                           kaz_mean.loc[1612],
                           kaz_mean.loc[1664]])
repo_acagen_un_max=np.concatenate([usa_max.loc[1302],
                            usa_max.loc[1364],
                            usa_max.loc[1426],
                            usa_max.loc[1488],
                            usa_max.loc[1550],
                           ...
                           kaz_max.loc[1612],
                           kaz_max.loc[1664]])
usa_min =  pd.rolling_min(dojo_vol, 62)
usa_mean =  pd.rolling_mean(dojo_vol, 62)
usa_max = pd.rolling_max(dojo_vol, 62)
kaz_min =  pd.rolling_min(kaz_indval, 50)
kaz_mean =  pd.rolling_mean(kaz_indval, 50)
kaz_max = pd.rolling_max(kaz_indval, 50)
indval_un_min=np.concatenate([usa_min.loc[1346],
                            usa_min.loc[1410],
                            usa_min.loc[1474],
                            usa_min.loc[1538],
                            usa_min.loc[1602],
                           ...
                           kaz_min.loc[1612],
                           kaz_min.loc[1664]])
indval_un_mean=np.concatenate([usa_mean.loc[1346],
                            usa_mean.loc[1410],
                            usa_mean.loc[1474],
                            usa_mean.loc[1538],
                            usa_mean.loc[1602],
                           ...
                           kaz_mean.loc[1612],
                           kaz_mean.loc[1664]])
indval_un_max=np.concatenate([usa_max.loc[1346],
                            usa_max.loc[1410],
                            usa_max.loc[1474],
                            usa_max.loc[1538],
                            usa_max.loc[1602],
                           ...
                           kaz_max.loc[1612],
                           kaz_max.loc[1664]])
usa_mean=pd.rolling_mean(usa_pr_vol,3)
kaz_mean =  pd.rolling_mean(kaz_value, 50)
repvol_un_oblmbs=np.concatenate([usa_mean.loc[3],
                            usa_mean.loc[6],
                            usa_mean.loc[9],
                            usa_mean.loc[12],
                            usa_mean.loc[15],
                           ...
                           kaz_mean.loc[1612],
                           kaz_mean.loc[1664]])
usa_mean=pd.rolling_mean(usa_pr_treu_vol,3)
kaz_mean =  pd.rolling_mean(kaz_value, 50)
repvol_un_obltreu=np.concatenate([usa_mean.loc[3],
                            usa_mean.loc[6],
                            usa_mean.loc[9],
                            usa_mean.loc[12],
                            usa_mean.loc[15],
                           ...
                           kaz_mean.loc[1612],
                           kaz_mean.loc[1664]])
usa_mean=pd.rolling_mean(usa_pr_agen_vol,3)
kaz_mean =  pd.rolling_mean(kaz_value, 50)
repvol_un_oblagen=np.concatenate([usa_mean.loc[3],
                            usa_mean.loc[6],
                            usa_mean.loc[9],
                            usa_mean.loc[12],
                            usa_mean.loc[15],
...
usa_mean=pd.rolling_mean(usa_pr_vol,3)
kaz_mean =  pd.rolling_mean(kaz_value, 50)
repvol_un_acmbs=np.concatenate([usa_mean.loc[3],
                            usa_mean.loc[6],
                            usa_mean.loc[9],
                            usa_mean.loc[12],
                            usa_mean.loc[15],
...
usa_mean=pd.rolling_mean(usa_pr_treu_vol,3)
kaz_mean =  pd.rolling_mean(kaz_value, 50)
repvol_un_actreu=np.concatenate([usa_mean.loc[3],
                            usa_mean.loc[6],
                            usa_mean.loc[9],
                            usa_mean.loc[12],
                            usa_mean.loc[15],
...
usa_mean=pd.rolling_mean(usa_pr_agen_vol,3)
kaz_mean =  pd.rolling_mean(kaz_value, 50)
repvol_un_acagen=np.concatenate([usa_mean.loc[3],
                            usa_mean.loc[6],
                            usa_mean.loc[9],
                            usa_mean.loc[12],
                            usa_mean.loc[15],
...
kv2 = pd.DataFrame({'Чистое приобретение ф.а.':kv_3,
                    ...
                    'РЕПО min обmb':repo_oblmbs_un_min,
                    'Индекс сред.':ind_un_mean,
                    'РЕПО mean обmb':repo_oblmbs_un_mean,
                    'Индекс min.':ind_un_min,
                    'РЕПО max обmb':repo_oblmbs_un_max,
                    'Индекс max.':ind_un_max,
                    'РЕПО min обtr':repo_obltreu_un_min,
                    'Индекс сред.об.':indval_un_mean,
                    'РЕПО mean обtr':repo_obltreu_un_mean,
                    'Индекс min val':indval_un_min,
                    'РЕПО max обtr':repo_obltreu_un_max,
                    'Индекс max val':indval_un_max,
                    'РЕПО min oblagen':repo_oblagen_un_min,
                    'РЕПО mean oblagen':repo_oblagen_un_mean,
                    'РЕПО max oblagen':repo_oblagen_un_max,
                    'РЕПО min acmb':repo_acmbs_un_min,
                    'РЕПО mean acmb':repo_acmbs_un_mean,
                    'РЕПО max acmb':repo_acmbs_un_max,
                    'РЕПО min actr':repo_actreu_un_min,
                    'РЕПО mean actr':repo_actreu_un_mean,
                    'РЕПО max actr':repo_actreu_un_max,
                    'РЕПО min acagen':repo_acagen_un_min,
                    'РЕПО mean acagen':repo_acagen_un_mean,
                    'РЕПО max acagen':repo_acagen_un_max,
                    'РЕПО об1':repvol_un_oblmbs,
                    'РЕПО об2':repvol_un_obltreu,
                    'РЕПО об3':repvol_un_oblagen,
                    'РЕПО об4':repvol_un_acmbs,
                    'РЕПО об5':repvol_un_actreu,
                    'РЕПО об6':repvol_un_acagen})
#kv2.to_excel('D:/work/data/usruskzshooort.xlsx')
#figure()
#plot(repvol_un_acmbs/100000, 'r', label='repo vol')
